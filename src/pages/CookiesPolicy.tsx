...
const CookiesPolicy = () => {
  return (
    <Layout>
      <Helmet>
        <title>Cookies Policy | Urban Eats Club</title>
        <meta name="description" content="Information about how Urban Eats Club uses cookies and similar technologies." />
      </Helmet>
      ...
      <div className="container-custom py-16 md:py-24">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
            <p>This Cookies Policy explains how Urban Eats Club ("we", "us", or "our") uses cookies and similar technologies to recognize you when you visit our website. It explains what these technologies are and why we use them, as well as your rights to control our use of them.</p>
            ...
            <p>Most web browsers allow some control of most cookies through the browser settings. To find out more about cookies, including how to see what cookies have been set, visit <a href="https://www.aboutcookies.org" className="text-urban-600 hover:underline">www.aboutcookies.org</a> or <a href="https://www.allaboutcookies.org" className="text-urban-600 hover:underline">www.allaboutcookies.org</a>.</p>
